...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1065584754643299344)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(1065584873284299345)
,p_region_id=>wwv_flow_imp.id(1065584754643299344)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(1065584930647299346)
,p_chart_id=>wwv_flow_imp.id(1065584873284299345)
,p_seq=>10
,p_name=>'Bugs'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1065585214360299348)
,p_chart_id=>wwv_flow_imp.id(1065584873284299345)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1065585120932299347)
,p_chart_id=>wwv_flow_imp.id(1065584873284299345)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1414455802201015260)
,p_plug_name=>'Top Bar'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1414457452650015265)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1414457709983015266)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1414646389770494700)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1414646665255500349)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1414646450205494701)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1414647949451526853)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1414456008555015260)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1414455802201015260)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1414456153195015261)
,p_name=>'P53_PRODUCT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1414455802201015260)
,p_item_default=>'0'
,p_prompt=>'Product'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1414456919356015264)
,p_name=>'P53_CATEGORY'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(1414455802201015260)
,p_item_default=>'0'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1415235830522032705)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1438262156821750261)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1438259251016750232)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438260533072750245)
,p_event_id=>wwv_flow_imp.id(1438259251016750232)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438261185980750251)
,p_event_id=>wwv_flow_imp.id(1438259251016750232)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438259979565750239)
,p_event_id=>wwv_flow_imp.id(1438259251016750232)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438260640463750246)
,p_event_id=>wwv_flow_imp.id(1438259251016750232)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_affected_region_id=>wwv_flow_imp.id(1414457452650015265)
,p_attribute_01=>'$(''.apex-rds-container'').parent(''div'').show();'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438260271215750242)
,p_event_id=>wwv_flow_imp.id(1438259251016750232)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438260949336750249)
,p_event_id=>wwv_flow_imp.id(1438259251016750232)
,p_event_result=>'FALSE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1065584754643299344)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438260391006750243)
,p_event_id=>wwv_flow_imp.id(1438259251016750232)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438261076220750250)
,p_event_id=>wwv_flow_imp.id(1438259251016750232)
,p_event_result=>'FALSE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1414457709983015266)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438260437638750244)
,p_event_id=>wwv_flow_imp.id(1438259251016750232)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438260751342750247)
,p_event_id=>wwv_flow_imp.id(1438259251016750232)
,p_event_result=>'FALSE'
,p_action_sequence=>50
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438260888926750248)
,p_event_id=>wwv_flow_imp.id(1438259251016750232)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1438261233041750252)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438261576006750255)
,p_event_id=>wwv_flow_imp.id(1438261233041750252)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438261403679750253)
,p_event_id=>wwv_flow_imp.id(1438261233041750252)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1438261459842750254)
,p_event_id=>wwv_flow_imp.id(1438261233041750252)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
