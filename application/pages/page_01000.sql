...
,p_group_id=>wwv_flow_imp.id(2506141727936820240)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(934809091411867930)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(934808961478867929)
,p_plug_name=>'Welcome to &APPLICATION_TITLE.'
,p_parent_plug_id=>wwv_flow_imp.id(934809091411867930)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(934809137875867931)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(934811313440867952)
,p_plug_name=>'ACL Level'
,p_parent_plug_id=>wwv_flow_imp.id(934809137875867931)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1225683798473288318)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(934809281693867932)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(934809398812867933)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(934811771285867957)
,p_name=>'Feature Configuration'
,p_parent_plug_id=>wwv_flow_imp.id(934809398812867933)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(934811922127867958)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(934812020281867959)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(934812102385867960)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(934812182520867961)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(934812257371867962)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(934812366697867963)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(934812438709867964)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(934812685844867966)
,p_plug_name=>'Users'
,p_region_css_classes=>'step-container'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(934809938044867939)
,p_name=>'Users'
,p_parent_plug_id=>wwv_flow_imp.id(934812685844867966)
,p_template=>wwv_flow_imp.id(1225683798473288318)
,p_display_sequence=>10
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(934813185363867971)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(847624078960254844)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(934813622199867975)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(934813246574867972)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1366272335684497038)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(847624304875254846)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(934813419543867973)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(934813472328867974)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(934812766098867967)
,p_plug_name=>'Buttons'
,p_region_css_classes=>'step-container'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(946140055642127527)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(934812839986867968)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(934812766098867967)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(946140193578127528)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(946140055642127527)
,p_button_name=>'OK'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(934811366087867953)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(934809938044867939)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(847624969923254853)
,p_branch_name=>'Go To Page HOME'
,p_branch_action=>'f?p=&APP_ID.:HOME_DESKTOP:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(934812839986867968)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(934809580175867935)
,p_name=>'P1000_LOAD_SAMPLE_YN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(934809281693867932)
,p_item_default=>'Y'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(934809729128867937)
,p_name=>'P1000_ACL_CONFIG'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(934811313440867952)
,p_item_default=>'PUBLIC_READONLY'
,p_prompt=>'Access Control Level'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'ACCESS CONTROL SCOPE'
,p_lov=>'.'||wwv_flow_imp.id(4380132737116096049)||'.'
,p_field_template=>wwv_flow_imp.id(1593548578216354144)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_encrypt_session_state_yn=>'N'
,p_attribute_01=>'1'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(935728457842470673)
...
,p_lov=>'.'||wwv_flow_imp.id(2622494454414957720)||'.'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(847623270779254836)
,p_name=>'Refresh Users Region on Modal Close'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(934811366087867953)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(847623397591254837)
,p_event_id=>wwv_flow_imp.id(847623270779254836)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(934809938044867939)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(847624767162254851)
,p_name=>'Refresh on edit'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(934809938044867939)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(847624920172254852)
,p_event_id=>wwv_flow_imp.id(847624767162254851)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(847623657219254840)
...
,p_internal_uid=>847623657219254840
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(847622787441254831)
...
,p_process_when2=>'PLSQL'
,p_internal_uid=>847622787441254831
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(847623094268254834)
...
,p_process_when_type=>'EXPRESSION'
,p_process_when2=>'PLSQL'
,p_internal_uid=>847623094268254834
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(847623518192254838)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>847623518192254838
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(847623922426254842)
,p_process_sequence=>10
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(934812839986867968)
...
,p_internal_uid=>847623922426254842
);
