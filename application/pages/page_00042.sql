...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1062939298396761742)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(1062939388966761743)
,p_region_id=>wwv_flow_imp.id(1062939298396761742)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(1062939528313761744)
,p_chart_id=>wwv_flow_imp.id(1062939388966761743)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1062939716488761746)
,p_chart_id=>wwv_flow_imp.id(1062939388966761743)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1062939625779761745)
,p_chart_id=>wwv_flow_imp.id(1062939388966761743)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1534571441896459300)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1534571903587459309)
,p_plug_name=>'Top Bar'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1534572951980459313)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1534572100263459309)
,p_name=>'P42_PRODUCT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1534571903587459309)
,p_item_default=>'0'
,p_prompt=>'Product'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1534572618869459312)
,p_name=>'P42_STATUS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(1534571903587459309)
,p_item_default=>'OPEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1534572775937459312)
,p_name=>'P42_FIX_BY'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(1534571903587459309)
,p_item_default=>'0'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1534794393707667116)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1496374950663049849)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496375075032049850)
,p_event_id=>wwv_flow_imp.id(1496374950663049849)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496375367400049853)
,p_event_id=>wwv_flow_imp.id(1496374950663049849)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496375165652049851)
,p_event_id=>wwv_flow_imp.id(1496374950663049849)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496375442553049854)
,p_event_id=>wwv_flow_imp.id(1496374950663049849)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496375610590049855)
,p_event_id=>wwv_flow_imp.id(1496374950663049849)
,p_event_result=>'FALSE'
...
,p_affected_region_id=>wwv_flow_imp.id(1062939298396761742)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496375269776049852)
,p_event_id=>wwv_flow_imp.id(1496374950663049849)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1496375713651049856)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496375777289049857)
,p_event_id=>wwv_flow_imp.id(1496375713651049856)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496375882387049858)
,p_event_id=>wwv_flow_imp.id(1496375713651049856)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1496375969241049859)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496376042694049860)
,p_event_id=>wwv_flow_imp.id(1496375969241049859)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496376200336049861)
,p_event_id=>wwv_flow_imp.id(1496375969241049859)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
