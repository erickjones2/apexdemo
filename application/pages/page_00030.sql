...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2723100544171610816)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2723101128295610818)
,p_plug_name=>'Introduction text'
,p_parent_plug_id=>wwv_flow_imp.id(2723100544171610816)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2723101357945610818)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(2723102156437610820)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2723102332482610820)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2723239056479542500)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2723102456432610820)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2723102541102610820)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2723100759928610818)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2723100927649610818)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(2723103438011610822)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2723101551853610818)
,p_name=>'P30_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2723101357945610818)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2723101729766610819)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2723101952694610820)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2723103147688610822)
...
,p_process_when_button_id=>wwv_flow_imp.id(2723100927649610818)
,p_process_success_message=>'Account verified'
,p_internal_uid=>2723103147688610822
);
