...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1017380228487077965)
...
,p_query_row_template=>wwv_flow_imp.id(1540743437476450428)
,p_query_num_rows=>15
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1065584258365299339)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1065584390665299340)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1065584434359299341)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1065584562831299342)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1065584713960299343)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1697488645736599984)
...
,p_ajax_enabled=>'Y'
,p_lazy_loading=>false
,p_query_row_template=>wwv_flow_imp.id(1449635398616265566)
,p_query_num_rows=>15
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_csv_output=>'N'
,p_prn_output=>'N'
,p_sort_null=>'L'
,p_plug_query_strip_html=>'N'
,p_required_patch=>wwv_flow_imp.id(1065271160137186238)
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(983388062871905638)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'Id'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(983388465089905639)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(983388901005905639)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(983389282392905639)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(983389657202905640)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3381965186219163518)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(983385806709903479)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'ID'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(983386140206903479)
,p_query_column_id=>2
,p_column_alias=>'ALERT_TYPE'
,p_column_display_sequence=>2
,p_column_heading=>'Alert type'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(983386532239903480)
,p_query_column_id=>3
,p_column_alias=>'ALERT_TITLE'
,p_column_display_sequence=>3
,p_column_heading=>'Alert title'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(983386997254903480)
,p_query_column_id=>4
,p_column_alias=>'ALERT_DESC'
,p_column_display_sequence=>4
,p_column_heading=>'Alert desc'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(983387359762903480)
,p_query_column_id=>5
,p_column_alias=>'ALERT_ACTION'
,p_column_display_sequence=>5
,p_column_heading=>'Alert action'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3492841532013481630)
,p_plug_name=>'&APPLICATION_TITLE.'
,p_icon_css_classes=>'app-bug-tracking'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1235076342164147026)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5363768601984404322)
,p_plug_name=>'Display As'
,p_parent_plug_id=>wwv_flow_imp.id(3492841532013481630)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4400433058174014145)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5580609075373905585)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(5580609185330905585)
,p_name=>'Products'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5580609366438905651)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5580609477192905658)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5580609584736905658)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5580609663120905659)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5580609769873905659)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5580609989603905660)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5580610190108905660)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4100555739775066411)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4100596935536084161)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4100699842770133481)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4523149131480431147)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4523149255518431150)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4523166027661704418)
,p_db_column_name=>'S1'
,p_display_order=>15
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4523166443245708892)
,p_db_column_name=>'S2'
,p_display_order=>16
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4523169141214736684)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4523169251820736684)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2509299144925395448)
,p_db_column_name=>'S3'
,p_display_order=>19
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2509310636951657431)
,p_db_column_name=>'S4'
,p_display_order=>20
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2509320236994870153)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1351705981888964987)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1376745538483005923)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1376745699209005926)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1422731540792487603)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1422731637766487611)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(5580610293254905902)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2509309956937647094)
,p_plug_name=>'Report Legend'
,p_parent_plug_id=>wwv_flow_imp.id(5580609075373905585)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1415234696747020556)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3492841532013481630)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(983382336525857969)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4475489753709901881)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(5580609075373905585)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1062952096847876078)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(941698962024969855)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(992810598307913029)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(980125059531680468)
,p_name=>'P8_LAST_WEEK'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2509309956937647094)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1017380033047077964)
,p_name=>'P8_DISPLAY_AS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(5363768601984404322)
,p_item_default=>'CARDS'
,p_prompt=>'Display as'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'PILL_DISPLAY_AS'
,p_lov=>'.'||wwv_flow_imp.id(1489586479860043362)||'.'
,p_field_template=>wwv_flow_imp.id(1225704767981288342)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1351717936443334219)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(5597468364096234242)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(941699654706969862)
,p_name=>'Refresh on Sync'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1062952096847876078)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(941699789529969863)
,p_event_id=>wwv_flow_imp.id(941699654706969862)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(5580609075373905585)
);
