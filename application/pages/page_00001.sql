...
,p_help_text=>'2This page shows several charts and graphs for products that the bugs in this application have been logged against. Changing the product filter on this page not only changes the results displayed on this page, but it also sets the selected product as '
...
,p_last_upd_yyyymmddhh24miss=>'20240605071919'
);
