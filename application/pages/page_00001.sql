...
,p_group_id=>wwv_flow_imp.id(2506150059449829428)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(37836208666131722)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'attribute_03', 'f?p=&APP_ID.:23:&SESSION.::&DEBUG.:RP,23,RIR,:IR_CUSTOMER_ID,IR_IS_OPEN:&ID.,Yes',
  'attribute_04', 'C',
  'attribute_11', 'VALUE',
  'attribute_14', '50',
  'attribute_15', 'TEXT',
  ...
  'attribute_17', 'MODERN',
  'attribute_18', 'ABOVE',
  'attribute_20', 'No open external customer bugs found.')).to_clob
,p_plug_comment=>'style="height: 208px; overflow: hidden;" data-grid="col_2" data-grid-start="no" '
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(678331167275157242)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(678331265553157243)
,p_region_id=>wwv_flow_imp.id(678331167275157242)
,p_chart_type=>'donut'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(678331377090157244)
,p_chart_id=>wwv_flow_imp.id(678331265553157243)
,p_seq=>10
,p_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(678331633554157247)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(678331783577157248)
,p_region_id=>wwv_flow_imp.id(678331633554157247)
,p_chart_type=>'bar'
,p_animation_on_display=>'none'
,p_animation_on_data_change=>'none'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(678331925975157249)
,p_chart_id=>wwv_flow_imp.id(678331783577157248)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(678332033169157251)
,p_chart_id=>wwv_flow_imp.id(678331783577157248)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(678331936555157250)
,p_chart_id=>wwv_flow_imp.id(678331783577157248)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(883556854784459871)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(883557093180459873)
,p_region_id=>wwv_flow_imp.id(883556854784459871)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(883557178505459874)
,p_chart_id=>wwv_flow_imp.id(883557093180459873)
,p_seq=>10
,p_name=>'Bugs'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(934808672812867926)
,p_chart_id=>wwv_flow_imp.id(883557093180459873)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(883557229873459875)
,p_chart_id=>wwv_flow_imp.id(883557093180459873)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'none'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1251654876762743539)
,p_name=>'Recent Bugs'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1366275067226497065)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1366275197360497066)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1366275242393497067)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1366275528227497069)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1366275812490497072)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1366276112706497075)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1525493133636756857)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1525493300015756858)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1342080310132321049)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'attribute_01', 'INITIALS',
  'attribute_02', 'CATEGORY_NAME',
  'attribute_03', 'f?p=&APP_ID.:23:&SESSION.::&DEBUG.:RP,23,RIR,:IR_CATEGORY,IR_IS_OPEN:&CATEGORY_NAME.,Yes',
  'attribute_04', 'C',
  'attribute_11', 'VALUE',
  'attribute_14', '20',
  'attribute_15', 'TEXT',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4388516439434739855)
,p_plug_name=>'Tags'
...
,p_plug_customized=>'1'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'attribute_01', 'f?p=&APP_ID.:23:&APP_SESSION.:::RIR:IRC_TAGS:#TAG#',
  'attribute_02', '100',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4396775241072571997)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5496427380280940723)
,p_plug_name=>'Top Bar'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(883556580021459868)
,p_plug_name=>'Product Filter'
,p_parent_plug_id=>wwv_flow_imp.id(5496427380280940723)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2434965735049417453)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5587574083078024019)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'attribute_03', 'f?p=&APP_ID.:23:&APP_SESSION.::&DEBUG.:23,RIR,RP:IR_PRODUCT_NAME:&PRODUCT_NAME.',
  'attribute_04', 'C',
  'attribute_11', 'VALUE',
  'attribute_14', '20',
  'attribute_15', 'TEXT',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5597464174112010049)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'attribute_01', 'INITIALS',
  'attribute_02', 'SEVERITY_NAME',
  'attribute_03', 'f?p=&APP_ID.:23:&SESSION.::&DEBUG.:RP,23,RIR,:IR_SEVERITY_NUMBER,IR_IS_OPEN:&SEVERITY_NUMBER.,Yes',
  'attribute_04', 'C',
  'attribute_11', 'VALUE',
  'attribute_14', '5',
  'attribute_15', 'TEXT',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5597466580055115818)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'attribute_01', 'INITIALS',
  'attribute_02', 'LABEL',
  'attribute_03', 'f?p=&APP_ID.:23:&SESSION.::&DEBUG.:RP,23,RIR,:IR_ASSIGNED_TO_ID,IR_IS_OPEN:&ASSIGNED_TO_ID.,Yes',
  'attribute_04', 'C',
  'attribute_11', 'VALUE',
  'attribute_14', '20',
  'attribute_15', 'TEXT',
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(5497236964960832444)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(883556580021459868)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1066008428611563569)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(9594180850946618485)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(883556992904459872)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(883556854784459871)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1342080393652321050)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1342080310132321049)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1058274075502793521)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(5496433183276007850)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1251654876762743539)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(5496434287348027894)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4399393057487224201)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_imp.id(5597466580055115818)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4399392427705215562)
,p_button_sequence=>80
,p_button_plug_id=>wwv_flow_imp.id(5587574083078024019)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4399393550476241088)
,p_button_sequence=>90
,p_button_plug_id=>wwv_flow_imp.id(5597464174112010049)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4454822044638086053)
,p_button_sequence=>100
,p_button_plug_id=>wwv_flow_imp.id(4388516439434739855)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(4390474550029521014)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(5496427774178948474)
,p_name=>'P1_PRODUCT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(883556580021459868)
,p_prompt=>'Product'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6325282581800521944)
,p_name=>'P1_LAST_PAGE_VISITED'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4396775241072571997)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(4390474239987518085)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(5597468190631232421)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(941699882240969864)
,p_name=>'Refresh Regions on Sync'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1058274075502793521)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(941700024537969865)
,p_event_id=>wwv_flow_imp.id(941699882240969864)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(5587574083078024019)
,p_attribute_01=>'location.reload();'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1350261644543451853)
...
,p_internal_uid=>1350261644543451853
);
