...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(87100791751380564)
,p_plug_name=>'Top Bar'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(87120715294443819)
,p_name=>'Timeline'
...
,p_query_row_template=>wwv_flow_imp.id(87907123231057300)
,p_query_num_rows=>15
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87121295363443833)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87121725449443834)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87122066742443834)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87122458810443834)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87122858096443835)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87123284370443835)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87123629493443835)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87124040963443836)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87124462743443837)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87124866906443837)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87125275041443837)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87125686542443838)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(87149040176491202)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(87103200647380588)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(87101154355380565)
,p_name=>'P87_PRODUCT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(87100791751380564)
,p_item_default=>'0'
,p_prompt=>'Product'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(87102079909380573)
,p_name=>'P87_STATUS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(87100791751380564)
,p_item_default=>'OPEN'
...
,p_lov=>'.'||wwv_flow_imp.id(1342752977689698528)||'.'
,p_cHeight=>1
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(87104817211380595)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(87924302264079724)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496373806314049837)
,p_event_id=>wwv_flow_imp.id(87924302264079724)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496374085123049840)
,p_event_id=>wwv_flow_imp.id(87924302264079724)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496373885993049838)
,p_event_id=>wwv_flow_imp.id(87924302264079724)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496374164472049841)
,p_event_id=>wwv_flow_imp.id(87924302264079724)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(87924688275079728)
,p_event_id=>wwv_flow_imp.id(87924302264079724)
,p_event_result=>'FALSE'
...
,p_affected_region_id=>wwv_flow_imp.id(87120715294443819)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496373994025049839)
,p_event_id=>wwv_flow_imp.id(87924302264079724)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496374262562049842)
,p_event_id=>wwv_flow_imp.id(87924302264079724)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1496374353285049843)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496374481084049844)
,p_event_id=>wwv_flow_imp.id(1496374353285049843)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496374650742049846)
,p_event_id=>wwv_flow_imp.id(1496374353285049843)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1496374550134049845)
,p_event_id=>wwv_flow_imp.id(1496374353285049843)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
